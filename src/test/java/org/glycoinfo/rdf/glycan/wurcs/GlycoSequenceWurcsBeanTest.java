...
@SpringApplicationConfiguration(classes = { GlycoSequenceWurcsBeanTest.class , VirtSesameTransactionConfig.class })
@Configuration
@EnableAutoConfiguration
public class GlycoSequenceWurcsBeanTest {
  private static final Log logger = LogFactory.getLog(GlycoSequenceWurcsBeanTest.class);
	
  static {
    
    new VirtSesameTransactionConfig();
  }
	@Autowired
	SparqlDAO sparqlDAO;
