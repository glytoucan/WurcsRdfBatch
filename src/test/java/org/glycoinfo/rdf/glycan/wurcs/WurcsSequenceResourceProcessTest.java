...
@SpringApplicationConfiguration(classes = { WurcsSequenceResourceProcessTest.class, WurcsSequenceResourceProcessConfig.class, VirtSesameTransactionConfig.class, GlyConvertConfig.class })
