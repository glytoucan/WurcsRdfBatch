...
public class WurcsRdfConvertSparqlBatch {

	private static final Log logger = LogFactory.getLog(WurcsRdfConvertSparqlBatch.class);
	...
	public static void main(String[] args) {
		...
		ApplicationContext ctx = SpringApplication.run(WurcsRdfConvertSparqlBatch.class, args);
	}
	...
	InsertSparql getInsertSparql() {
		WurcsRDFInsertSparql insert = new WurcsRDFInsertSparql();
